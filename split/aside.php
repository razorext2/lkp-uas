...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href="#">
      ...
      <span class="ms-1 font-weight-bold">SRH - InfoCenter</span>
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link <?= $d; ?>" href="index_admin.php">
      ...
      <li class="nav-item">
        <a class="nav-link <?= $n; ?>" href="?page=peserta&actions=tampil">
          ...
          <span class="nav-link-text ms-1">Peserta Kursus</span>
        </a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link <?= $b; ?>" href="?page=instruktur&actions=tampil">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link <?= $c; ?>" href="?page=kursus&actions=tampil">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>box-3d-50</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <span class="nav-link-text ms-1">Jenis Kursus</span>
        </a>
      </li>
      <li class="nav-item">
        <div class="sidenav-footer mx-3">
          <a class="btn bg-gradient-primary mt-4 w-100" href="conn/logout.php" type="button">Log Out</a>
        </div>
      </li>
    </ul>
  </div>
